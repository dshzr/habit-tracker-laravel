    ...
    <div class="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-sm space-y-8">
            ...
            <div class="text-center">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900">Entrar no HabitTracker</h1>
                <p class="mt-2 text-sm text-gray-500">
                    Não tem uma conta?
                    <a href="/register"
                        class="font-medium text-blue-600 hover:text-blue-500 hover:underline transition-all">Cadastre-se</a>
                </p>
            </div>
            ...
            <form class="mt-8 space-y-5" action="/login" method="POST">
                ...
                <div class="flex items-center">
                    ...
                    <label for="remember-me" class="ml-2 block text-sm text-gray-600 cursor-pointer">Lembrar de
                        mim</label>
                </div>

                <div>
                    <button type="submit"
                        class="group relative flex w-full justify-center rounded-md bg-blue-500 px-3 py-2.5 text-sm font-semibold text-white transition-all hover:bg-blue-600 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-blue-600 active:scale-[0.98] cursor-pointer">
                        Entrar
                    </button>
                </div>
            </form>
